...
public class test {
	...
	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
		  ...
		  System.out.println("123 update");
		//
		  
		 String sURL = "https://www.google.com.tw/?gws_rd=cr&ei=xjNrU8SvNYbkkgXhjYH4Bg#q=123";
		    System.out.println(sURL);
		    URL url = new URL(sURL);
		    HttpURLConnection httpCon = (HttpURLConnection) url.openConnection();
		    //set http request headers
		            httpCon.addRequestProperty("Host", "https://www.google.com.tw/?gws_rd=cr&ei=xjNrU8SvNYbkkgXhjYH4Bg#q=123");
		            ...
		            int controlwrtiesignal=0;
		            while ((inputLine = in.readLine()) != null){
		            	if(inputLine.contains("<p")){controlwrtiesignal=1;}
		            if(controlwrtiesignal==1){	
		            System.out.println(inputLine);
		            }
		            if(inputLine.contains("/p>"))
		            	controlwrtiesignal=0;
		            }
		            in.close();
